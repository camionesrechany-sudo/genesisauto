  ...
  return (
    <main className="site-shell home-page">
      ...
      <section className="home-hero">
        ...
        <div className="factory-scene" aria-label={language === "en" ? "Intelligent EV manufacturing cell" : "智能电动汽车制造单元"}>
          <div className="factory-hud hud-top"><span>GEN / LINE 01</span><i />{language === "en" ? "SYSTEM ONLINE" : "系统在线"}</div>
          <div className="assembly-rail rail-a" /><div className="assembly-rail rail-b" />
          <div className="robot-arm arm-left"><i /><b /><span /></div>
          <div className="robot-arm arm-right"><i /><b /><span /></div>
          <div className="vehicle-wireframe">
            <div className="vehicle-roof" /><div className="vehicle-body" /><div className="vehicle-cabin" />
            <span className="wheel wheel-left" /><span className="wheel wheel-right" /><i className="scan-line" />
          </div>
